...
<<FigS3a, fig.width=8, fig.height=6>>=
...
<<>>=
load("simResults_pi0x_thresh_2.RData")
load("simResults_pi0x_Scott_2.RData")
@

\subsection{Plot for means}

<<FigS3b, fig.width=8, fig.height=6>>=
...
<<FigS3c, fig.width=8, fig.height=6>>=
...
<<>>=
load("simResults_pi0x_thresh_3.RData")
load("simResults_pi0x_Scott_3.RData")
@

\subsection{Plot for means}

<<FigS3d, fig.width=8, fig.height=6>>=
...
<<FigS3e, fig.width=8, fig.height=6>>=
